...
This module implements the sync retry loop. It uses shared logic from
...
def _run_sync_call(
    *,
    ...
    """Execute func with retries, raising on failure."""
    state = _RetryState(
        policy=policy,
        on_metric=on_metric,
        on_log=on_log,
...
def _run_sync_execute(
    *,
    ...
    """Execute func with retries, returning outcome."""
